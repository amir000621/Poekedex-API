...
function PokemonList(){
    ...
    //callback and dependency array ye do chije useeffect expect krta hia 
    //call back ke andar ham jo bhi logic likhenge vo execute hoga pehli baar to jab execute hoga jab component pehli baar return hoga
    //ye khali array call back ko detect krne ke liye 
    ...
    //use effect name ke hook hame help krta hai ki kisi component ke render pr tumhe kya krna hai uske dobara render pr  kya krna chahte hai
    ...
    {/* undefined ki jagah null bhi daal sakte hai */}
        <button disabled = { pokemonListState.prevUrl === undefined} onClick={()=>setPokemonListState({...pokemonListState,pokedexUrl:pokemonListState.prevUrl})} className="controls" >Prev</button>
